...
const FAMOUS_PLACES = {
    historical: [
        { name: 'French War Memorial', location: 'Goubert Avenue', image: '/assets/heritage/french-war-memorial/photo-1.jpg' },
        { name: 'Aayi Mandapam', location: 'White Town', image: '/assets/heritage/aayi-mandapam/photo-1.jpg' },
        { name: 'Bharathi Park', location: 'White Town', image: '/assets/heritage/bharathi-park/photo-1.jpg' },
        { name: 'Arikamedu Archaeological Site', location: 'Arikamedu', image: '/assets/heritage/arikamedu-archaeological/photo-1.jpg' },
        { name: 'Kargil War Memorial', location: 'Shanmugha Vilasam', image: '/assets/heritage/kargil-war-memorial/photo-1.jpg' },
        { name: 'Raj Niwas', location: 'White Town', image: '/assets/heritage/raj-niwas/photo-1.jpg' },
    ],
    temples: [
        { name: 'Manakula Vinayagar Temple', location: 'White Town', image: '/assets/temples-spiritual/manakula-vinayagar-temple/photo-1.jpg' },
        { name: 'Varadaraja Perumal Temple', location: 'Near French Consulate', image: '/assets/temples-spiritual/varadaraja-perumal-temple/photo-1.jpg' },
        { name: 'Kamakshi Amman Temple', location: 'Near Beach', image: '/assets/temples-spiritual/kamakshi-amman-temple/photo-1.jpg' },
        { name: 'Vedapureeswarar Temple', location: 'Near Serenity Beach', image: '/assets/temples-spiritual/vedapureeswarar-temple/photo-1.jpg' },
        { name: 'Arulmigu Kanniga Parameswari Temple', location: 'Kuruchikuppam', image: '/assets/temples-spiritual/arulmigu-kanniga-parameswari-temple/photo-1.jpg' },
    ],
    nature: [
        { name: 'Paradise Beach', location: 'Chunnambar', image: '/assets/beaches/paradise-beach/photo-1.jpg' },
        { name: 'Auroville Beach', location: 'Auroville', image: '/assets/beaches/auroville-beach/photo-1.jpg' },
        { name: 'Serenity Beach', location: 'Auroville Road', image: '/assets/beaches/serenity-beach/photo-1.jpg' },
        { name: 'Ousteri Lake', location: 'Ossudu', image: '/assets/nature/ousteri-lake/photo-1.jpg' },
        { name: 'Botanical Gardens', location: 'Near Railway Station', image: '/assets/nature/botanical-gardens/photo-1.jpg' },
        { name: 'Pichavaram Mangroves', location: 'Near Chidambaram', image: '/assets/nature/pichavaram-mangroves/photo-1.jpg' },
        { name: 'Bharathi Park', location: 'White Town', image: '/assets/heritage/bharathi-park/photo-2.jpg' },
    ],
    churches: [
        { name: 'Sacred Heart Basilica', location: 'Subbaiah Salai', image: '/assets/temples-spiritual/sacred-heart-basilica/photo-1.jpg' },
        { name: 'Immaculate Conception Cathedral', location: 'Mission Street', image: '/assets/temples-spiritual/sacred-heart-basilica/photo-2.jpg' },
        { name: 'Our Lady of Angels Church', location: 'Rue Dumas', image: '/assets/temples-spiritual/our-lady-of-angels-church/photo-1.jpg' },
        { name: "St. Andrew's Church", location: 'Church Street', image: '/assets/temples-spiritual/st.andrews-church/photo-1.jpg' },
    ],
    popular: [
        { name: 'Promenade Beach', location: 'Beach Road', image: '/assets/beaches/promenade-beach/photo-1.jpg' },
        { name: 'Sri Aurobindo Ashram', location: 'Marine Street', image: '/assets/temples-spiritual/sri-aurobindo-ashram/photo-1.jpg' },
        { name: 'Matrimandir', location: 'Auroville', image: '/assets/temples-spiritual/matrimandir/photo-1.jpg' },
        { name: 'Puducherry Museum', location: 'Bharathi Park', image: '/assets/heritage/puducherry-museum/photo-1.jpg' },
        { name: 'White Town Walks', location: 'French Quarter', image: '/assets/heritage/white-town-tales/photo-1.jpg' },
        { name: 'Chunnambar Backwater', location: 'Chunnambar', image: '/assets/beaches/chunnambar-backwater/photo-1.jpg' },
        { name: 'Serenity Beach', location: 'Kottakuppam', image: '/assets/beaches/serenity-beach/photo-2.jpg' },
        { name: 'Paradise Beach', location: 'Chunnambar', image: '/assets/beaches/paradise-beach/photo-2.jpg' },
    ],
    food: [
