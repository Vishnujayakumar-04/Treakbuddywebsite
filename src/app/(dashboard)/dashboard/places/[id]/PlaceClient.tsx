                            ...
                            <div className="aspect-video rounded-lg overflow-hidden border border-slate-200 dark:border-slate-700">
                                {process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY ? (
                                    <APIProvider apiKey={process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY}>
                                        <Map 
                                            defaultCenter={coords || { lat: 11.9416, lng: 79.8083 }} 
                                            defaultZoom={coords ? 16 : 13} 
                                        ...
                                        >
                                            {coords && (
                                                <AdvancedMarker position={coords}>
                                                    <div className="w-10 h-10 bg-cyan-600 rounded-full border-4 border-white shadow-xl flex items-center justify-center text-white pb-1 z-10 transition-transform hover:scale-110">
                                                        <MapPin className="w-5 h-5 fill-cyan-400" />
                                                    </div>
                                                </AdvancedMarker>
                                            )}
                                        </Map>
