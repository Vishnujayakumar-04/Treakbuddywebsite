...
const CATEGORY_META: Record<string, CategoryMeta> = {
    'music': {
        ...
        heroImage: '/assets/heritage/white-town-tales/photo-1.jpg',
        followers: '3.7M+',
    },
    'concerts': {
        title: 'Concerts',
    ...
    'adventure': {
        ...
        heroImage: '/assets/beaches/auroville-beach/photo-1.jpg',
        followers: '450.2k+',
    }
};
...
export default function CategoryPage({ params }: { params: Promise<{ category: string }> }) {
    ...
    const meta = CATEGORY_META[categoryId] || {
        ...
        heroImage: '/assets/beaches/promenade-beach/photo-1.jpg',
        followers: '100k+',
    };
