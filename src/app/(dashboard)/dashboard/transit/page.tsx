...
export default function TransitPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl pt-4 pb-8 sm:pt-6 sm:pb-12">
                ...
                <div className="mb-4">
                    ...
                    >
                        <div className="w-8 h-8 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center shadow-sm group-hover:shadow-md transition-all">
