    ...
    return (
        <View style={[styles.container, isDark && styles.containerDark]}>
            <View style={[styles.header, isDark && styles.headerDark]}>
                ...
                <Text style={[styles.headerTitle, isDark && { color: '#fff' }]}>Privacy Policy</Text>
            </View>
            <ScrollView contentContainerStyle={styles.content}>
                <Text style={[styles.text, isDark && { color: '#cbd5e1' }]}>
                    Your privacy is critically important to us. This application respects your location and personal data...
                </Text>
            </ScrollView>
        </View>
    );
