...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 22, fontWeight: '800', color: '#f8fafc', marginBottom: 12 },
  sectionSubtitle: { fontSize: 14, color: 'rgba(255,255,255,0.6)' },
  countText: { fontSize: 12, color: 'rgba(255,255,255,0.6)', fontWeight: '600', marginBottom: 12 },
  ...
  ratingText: { fontSize: 12, fontWeight: '700', color: '#f8fafc' },

  rentalContent: { padding: 14 },
  rentalName: { fontSize: 16, fontWeight: '800', color: '#f8fafc', marginBottom: 4 },
  rentalLocationRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
  rentalLocationIcon: { fontSize: 12, marginRight: 3 },
  rentalLocation: { fontSize: 12, color: 'rgba(255,255,255,0.6)', flex: 1 },
  rentalCategoryPill: {
    alignSelf: 'flex-start',
    backgroundColor: 'rgba(255,255,255,0.1)',
    borderRadius: 8,
  ...
  rentalCategoryText: { fontSize: 11, color: 'rgba(255,255,255,0.6)', fontWeight: '600' },
  rentalDivider: { height: 1, backgroundColor: 'rgba(255,255,255,0.1)', marginBottom: 10 },
  ...
  tipContent: { flex: 1 },
  tipTitle: { fontSize: 14, fontWeight: '800', color: '#93c5fd', marginBottom: 4 },
  tipText: { fontSize: 13, color: '#93c5fd', lineHeight: 20 },
  ...
  cabSubTabText: { fontSize: 13, fontWeight: '600', color: 'rgba(255,255,255,0.6)' },
  ...
  cabName: { fontSize: 17, fontWeight: '800', color: '#f8fafc', marginBottom: 2 },
  cabDescription: { fontSize: 13, color: 'rgba(255,255,255,0.6)', lineHeight: 18 },
  cabTipBadge: {
    backgroundColor: 'rgba(245,158,11,0.15)',
    borderRadius: 8,
    paddingHorizontal: 8,
  ...
  cabStatGreen: { backgroundColor: 'rgba(16,185,129,0.15)' },
  cabStatBlue: { backgroundColor: 'rgba(59,130,246,0.15)' },
  cabStatOrange: { backgroundColor: 'rgba(234,88,12,0.15)' },
  cabStatPurple: { backgroundColor: 'rgba(168,85,247,0.15)' },
  cabStatLabel: { fontSize: 9, fontWeight: '800', color: '#94a3b8', letterSpacing: 1, marginBottom: 2 },
  cabStatValue: { fontSize: 12, fontWeight: '700', color: '#f8fafc' },

  cabBookingSection: { borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.1)', paddingTop: 12 },
  cabBookingLabel: { fontSize: 10, fontWeight: '800', color: 'rgba(255,255,255,0.6)', letterSpacing: 1, marginBottom: 8 },
  ...
  operatorName: { fontSize: 15, fontWeight: '700', color: '#f8fafc', marginBottom: 2 },
  operatorSpecialty: { fontSize: 12, color: 'rgba(255,255,255,0.6)', lineHeight: 18 },
  ...
  busSubTabText: { fontSize: 13, fontWeight: '600', color: 'rgba(255,255,255,0.6)' },
  ...
  busTitle: { flex: 1, fontSize: 15, fontWeight: '700', color: '#f8fafc' },
  busType: { fontSize: 12, color: 'rgba(255,255,255,0.6)', marginTop: 1 },
  busPriceBadge: {
  ...
  busFrom: { flex: 1, fontSize: 13, fontWeight: '700', color: '#f8fafc' },
  busArrow: { color: '#94a3b8', fontSize: 14 },
  busTo: { flex: 1, fontSize: 13, fontWeight: '700', color: '#f8fafc', textAlign: 'right' },
  busSchedule: { fontSize: 13, color: '#475569', marginBottom: 8 },
  busViaContainer: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'flex-start', borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.1)', paddingTop: 8 },
  ...
  trainSectionLabel: { fontSize: 16, fontWeight: '800', color: '#f8fafc', marginBottom: 12 },
  ...
  trainName: { fontSize: 15, fontWeight: '800', color: '#f8fafc', marginBottom: 12 },
  ...
  trainStopName: { fontSize: 12, fontWeight: '700', color: '#f8fafc', lineHeight: 16 },
  trainDeparture: { fontSize: 14, fontWeight: '800', color: '#4f46e5', marginTop: 2 },
  trainConnector: { flex: 1, alignItems: 'center', gap: 4 },
  trainLine: { height: 1, width: '80%', backgroundColor: 'rgba(255,255,255,0.15)' },
  trainDuration: { fontSize: 10, fontWeight: '700', color: 'rgba(255,255,255,0.6)', textAlign: 'center' },
  ...
  trainClasses: { fontSize: 12, color: 'rgba(255,255,255,0.6)', fontWeight: '600', flex: 1 },
